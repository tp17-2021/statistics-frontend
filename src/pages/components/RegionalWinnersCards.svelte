<script>
  import { addZeroes } from "../../lib/helpers/helpers.js";
  export let lookup;
        ...
        <div class="col-md-6 col-lg-4">
          <div class="idsk-card idsk-card-basic w-100 shadow p-3">
            <div class="idsk-card-content idsk-card-content-basic">
              <div class="idsk-heading idsk-heading-basic text-center">
                <span
                  href="#"
              ...
              <div class="mb-3 text-center small">
                Volebná účasť: {addZeroes(region_data.participation)}&nbsp;%
              </div>
                      ...
                      <div class="progress mb-1 w-100" style="height: 2rem;">
                        <div
                          ...
                          style="width: {party.percentage *
                            getFirstPartyCoefficient(
                              region_data
                            )}%; background-color: {lookup.parties[party.id]
                            .color}"
                        ...
                        >
                          {addZeroes(
                            Math.round(
                              lookup.parties[party.id].percentage * 100
                            ) / 100
                          )} %
                        </div>
                      </div>
